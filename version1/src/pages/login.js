...
function Signup(){
    ...
    const handleSubmission = async (e) => {
        ...
        try {
          const response = await axios.post('http://localhost:4567/login', { email:email, password: pass });
    ...
    return (
        <div>
            <Header />
            <div style={{ backgroundColor: " rgb(243, 247, 243)", height: "100vh" }} className="d-flex justify-content-center align-items-center">
                <div className="bg-light p-5 rounded shadow" style={{ width: "100%", maxWidth: "400px" }}>
                    <center><h2 style={{color: "rgb(31, 160, 246)"}}>LOGIN</h2></center><br/><br/>
